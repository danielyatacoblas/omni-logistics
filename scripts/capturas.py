...
"""Genera las capturas del README a partir de la aplicación de verdad.
    ...
    python -m uvicorn backend.main:app --port 8021     # en otra consola
...
ESCENAS = [
    ("01-ocupacion", "tablero", "OCUPACIÓN POR ZONA", "ocupacion", 18, 1500, 1000),
    ("02-muelle", "tablero", "CARGADESCARGA", "muelle", 18, 1500, 1000),
    ("03-seguridad-fuego", "tablero", "FUEGO", "seguridad", 20, 1500, 1000),
    ("04-trazabilidad", "tablero", "TRAZABILIDAD", "trazabilidad", 18, 1500, 1000),
    ("05-editor-de-zonas", "editor", "OCUPACIÓN POR ZONA", "ocupacion", 0, 1500, 1000),
]
