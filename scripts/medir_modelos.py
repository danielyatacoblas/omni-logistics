...
MODELOS = [
    ("weights/pallet_n_640.pt", "Pallets",
     "videos/01_ocupacion/almacen_racks_720.mp4", 0.35),
    ("weights/forklift_kerem.pt", "Montacargas y personas",
     "videos/03_seguridad/forklift_almacen_720.mp4", 0.35),
    ("weights/fire_smoke.pt", "Fuego y humo",
     "videos/03_seguridad/fuego_test.mp4", 0.35),
    ("weights/ppe_vest.pt", "Chaleco y casco",
     "videos/03_seguridad/forklift_almacen_720.mp4", 0.35),
    ("weights/yolo11n.pt", "Base genérica",
     "videos/01_ocupacion/almacen_racks_720.mp4", 0.35),
]

# Lo que publica quien entrenó cada modelo, para lo que el .pt no trae.
FUENTES = {
    "pallet_n_640.pt": ("YOLO11n afinado con pallets de madera",
     None),
    "forklift_kerem.pt": ("keremberke · forklift",
     "https://huggingface.co/keremberke/yolov8m-forklift-detection"),
    "fire_smoke.pt": ("YOLOv8n afinado con fuego y humo",
     None),
    "ppe_vest.pt": ("Detector de EPP de terceros",
     None),
...
UMBRALES = [
    ("Confianza · general", "0.35",
     "Pallets y montacargas son objetos grandes y con forma clara; no hace falta bajarlo más."),
    ("Confianza · fuego y humo", "0.50",
     "El más alto de todos, y encima con comprobación de brillo. Un falso incendio al día y en una semana nadie mira la alarma."),
    ("Confianza · EPP", "0.40",
     "Chaleco y casco son pequeños en una toma de almacén; un poco por encima del general para no marcar infracciones que no existen."),
    ("IoU de NMS", "0.60",
     "Los pallets apilados se solapan mucho entre sí; más bajo los fundiría en uno solo y la ocupación saldría a la mitad."),
    ("Activación de ByteTrack", "0.25",
     "Un montacargas se tapa detrás de un rack constantemente."),
]
